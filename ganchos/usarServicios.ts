...
export function usarServicios({ supabase, enviarNotificacionIndividual, registrarAuditoria }: UseServiciosProps) {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            if (equipos) setAllTeams(equipos);
            if (miembros) setAllMembers(miembros);
