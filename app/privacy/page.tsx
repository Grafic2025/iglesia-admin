        ...
        <div className="min-h-screen bg-[#0d0d0d] text-white p-8 md:p-20 font-sans">
            <div className="max-w-4xl mx-auto space-y-12">
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl font-bold border-l-4 border-accent pl-4">1. Introducción</h2>
                ...
                <section className="space-y-4">
                    <h2 className="text-2xl font-bold border-l-4 border-accent pl-4">2. Información que Recopilamos</h2>
                    <p className="text-[#aaa] leading-relaxed">
                ...
                {/* Section: Purpose */}
                <section className="space-y-4">
                    <h2 className="text-2xl font-bold border-l-4 border-accent pl-4">3. Uso de la Información</h2>
                    <p className="text-[#aaa] leading-relaxed">
                ...
                <section className="space-y-6 bg-[#1a1a1a] p-8 rounded-2xl border border-[#333]">
                    <h2 className="text-2xl font-bold text-accent">4. Eliminación de Datos y Cuenta</h2>
                    <p className="text-[#aaa] leading-relaxed">
                ...
                {/* Section: Security */}
                <section className="space-y-4">
                    <h2 className="text-2xl font-bold border-l-4 border-accent pl-4">5. Seguridad de Datos</h2>
                    <p className="text-[#aaa] leading-relaxed">
                ...
                {/* Section: Contact */}
                <section className="space-y-4">
                    <h2 className="text-2xl font-bold border-l-4 border-accent pl-4">6. Contacto</h2>
                    <p className="text-[#aaa] leading-relaxed">
