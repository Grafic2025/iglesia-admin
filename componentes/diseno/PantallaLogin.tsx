                ...
                {!loginLocked && setModoRecuperacion && (
                    <div className="mt-6 text-center">
                        <button 
                            ...
                            className="text-white/50 hover:text-[#A8D500] text-xs font-bold uppercase tracking-widest transition-colors"
                        >
                            ...
                            <form onSubmit={solicitarCodigo} className="space-y-4">
                                <div>
                                    ...
                                    <input 
                                        ...
                                        className="w-full p-4 bg-[#2a2a2a] border border-white/10 rounded-xl text-white outline-none focus:border-[#A8D500]"
                                    />
                                </div>
                                <button 
                                    disabled={cargandoRecuperacion}
                                    type="submit"
                                    className="w-full py-4 bg-[#A8D500] text-black font-black uppercase tracking-widest rounded-xl hover:scale-105 transition-transform"
                                >
                            ...
                            <form onSubmit={resetearPassword} className="space-y-4">
                                <div>
                                    ...
                                    <input 
                                        ...
                                        placeholder="123456"
                                        className="w-full p-4 bg-[#2a2a2a] border border-white/10 rounded-xl text-white text-center text-2xl font-black tracking-[10px] outline-none focus:border-[#A8D500]"
                                    />
                                </div>
                                <div>
