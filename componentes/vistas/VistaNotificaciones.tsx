...
import { usarNotificacionesAdmin } from '../../ganchos/usarNotificacionesAdmin';
...
const VistaNotificaciones = ({
    ...
    } = usarNotificacionesAdmin({ supabase, logs, fetchProgramaciones, registrarAuditoria });
        ...
        <div className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div className="bg-[#1E1E1E] p-6 rounded-2xl border border-[#333]">
                    <h3 className="text-accent text-lg font-bold flex items-center gap-2 mb-6">
                    ...
                    <div className="space-y-4">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full bg-[#252525] border border-[#333] rounded-xl px-4 py-2.5 text-white outline-none focus:border-accent"
                            />
                        </div>
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full bg-[#252525] border border-[#333] rounded-xl px-4 py-4 text-white outline-none focus:border-accent h-32 resize-none"
                            />
                        </div>
                        ...
                        <button
                            ...
                            disabled={enviando}
                            className={`w-full py-4 rounded-xl font-bold transition-all active:scale-[0.98] ${enviando ? 'bg-[#333] text-[rgba(255,255,255,0.7)]' : 'bg-accent text-black shadow-[0_4px_15px_rgba(168,213,0,0.3)]'
                                }`}
                        >
                            {enviando ? 'PROCESANDO...' : 'ENVIAR NOTIFICACIÓN AHORA'}
                        </button>
                        {notificacionStatus.show && (
                            <div className={`mt-4 text-center font-bold ${notificacionStatus.error ? 'text-red-500' : 'text-accent'}`}>
                        ...
                        {cronogramas.map((p) => (
                            <div key={p.id} className="bg-[#252525] p-3 rounded-xl border border-[#333] flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    <div className={`w-2 h-2 rounded-full ${p.ultimo_estado === 'Exitoso' ? 'bg-accent' : 'bg-[rgba(255,255,255,0.5)]'}`} />
                                    <div>
                    ...
                    <div className="flex gap-3 flex-wrap">
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="bg-[#252525] border border-[#333] rounded-xl pl-9 pr-4 py-2 text-white text-sm outline-none focus:border-accent w-72"
                            />
                        </div>
                        <select
                            ...
                            {loading ? (
                                ...
                                paginatedLogs.map((l) => (
                                    <tr key={l.id} className="text-sm hover:bg-[#222] transition-colors">
                                        ...
                                        <td className={`px-4 py-4 font-bold ${l.estado === 'Exitoso' ? 'text-accent' : 'text-red-500'}`}>{l.estado}</td>
                                    </tr>
                                ))
                            )}
                        </tbody>
