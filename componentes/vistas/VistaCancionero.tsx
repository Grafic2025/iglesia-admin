...
// Modular Components
import TablaCanciones from '../administrador/cancionero/TablaCanciones';
import ModalEditorCancion from '../administrador/cancionero/ModalEditorCancion';
import ModalLetrasCancion from '../administrador/cancionero/ModalLetrasCancion';

import { usarCancionero } from '../../ganchos/usarCancionero';

const VistaCancionero = ({ supabase }: { supabase: any }) => {
    const {
        loading,
        songs,
...
export default VistaCancionero;
