            ...
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-bold text-white flex items-center gap-2">
                        <History className="text-accent" /> AUDITORÍA DE ACCIONES
                    </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-3">
                <div className="relative flex-1">
                    ...
                    <input
                        ...
                        className="w-full bg-[#1E1E1E] border border-[#333] rounded-2xl py-3 pl-12 pr-4 text-white outline-none focus:border-accent transition-all text-sm"
                    />
                </div>
                <div className="relative">
                    ...
                    <select
                        ...
                        className="bg-[#1E1E1E] border border-[#333] rounded-2xl pl-9 pr-6 py-3 text-white text-sm outline-none focus:border-accent appearance-none min-w-[200px]"
                    >
