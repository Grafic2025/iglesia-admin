        ...
        <div className="space-y-6">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <button 
                    ...
                    className="group bg-white/5 hover:bg-accent text-white hover:text-black border border-white/10 hover:border-transparent px-6 py-3 rounded-2xl font-black text-sm tracking-widest uppercase transition-all flex items-center gap-3 shadow-xl"
                >
