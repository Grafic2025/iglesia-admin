        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-2xl font-bold text-white flex items-center gap-2">
                        <Calendar className="text-accent" /> PLANIFICACIÓN (CRONOGRAMAS)
                    </h2>
            ...
            <div className="relative w-full">
                ...
                <input
                    ...
                    className="w-full pl-12 pr-4 py-3 bg-[#1e1e1e] border border-white/5 rounded-xl text-white placeholder-white/60 focus:outline-none focus:ring-1 focus:ring-accent transition-all font-medium"
                />
            </div>
