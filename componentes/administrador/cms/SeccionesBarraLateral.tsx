...
interface BarraLateralSectionsProps {
    bautismos: any[];
    ayuda: any[];
    miembros: any[];
}

const BarraLateralSections: React.FC<BarraLateralSectionsProps> = ({ bautismos, ayuda, miembros }) => {
    return (
        <div className="space-y-6">
            <div className="bg-[#1E1E1E] p-6 rounded-2xl border border-[#333]">
                ...
                <div className="space-y-3 max-h-[250px] overflow-y-auto pr-2 custom-scrollbar">
                    {bautismos.length === 0 && <p className="text-[rgba(255,255,255,0.5)] text-center py-4 italic">Sin solicitudes nuevas</p>}
                    {bautismos.map((b) => {
                        ...
                        return (
                            <div key={b.id} className="bg-[#252525] p-4 rounded-xl border border-[#333] text-left">
                                ...
                                <div className="flex gap-4 mt-2">
                                    <div className="text-[10px] text-[rgba(255,255,255,0.7)]">Edad: <span className="text-white">{b.edad}</span></div>
                                    <div className="text-[10px] text-[rgba(255,255,255,0.7)]">Grupo: <span className="text-white">{b.pertenece_grupo}</span></div>
                                </div>
            ...
            <div className="bg-[#1E1E1E] p-6 rounded-2xl border border-[#333]">
                ...
                <div className="space-y-3 max-h-[250px] overflow-y-auto pr-2 custom-scrollbar">
                    {ayuda.length === 0 && <p className="text-[rgba(255,255,255,0.5)] text-center py-4 italic">Todo en orden</p>}
                    {ayuda.map((a) => {
...
export default BarraLateralSections;
