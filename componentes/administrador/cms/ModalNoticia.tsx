            ...
            <div className="bg-[#1E1E1E] border border-[#333] w-full max-w-4xl rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row text-left">
                <div className="flex-1 p-6 space-y-4 max-h-[85vh] overflow-y-auto border-r border-[#333] custom-scrollbar">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <button onClick={onClose} className="text-[rgba(255,255,255,0.7)] md:hidden"><X /></button>
                    </div>
                    <div>
                    ...
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2">
                            <input type="checkbox" checked={activa} onChange={e => setActiva(e.target.checked)} className="accent-[var(--accent)] w-4 h-4" />
                ...
                <div className="w-full md:w-[320px] bg-[#121212] p-6 flex flex-col items-center justify-center">
                    <div className="flex justify-between w-full mb-4">
                        <h4 className="text-[rgba(255,255,255,0.5)] text-[9px] font-bold uppercase tracking-widest">Vista Previa App</h4>
                        <button onClick={onClose} className="text-[rgba(255,255,255,0.7)] hidden md:block"><X /></button>
                    </div>
                    ...
                    <div className="mt-8 bg-[#1E1E1E] p-4 rounded-2xl border border-[#333] w-full">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="text-left">
                                ...
                                <div className="text-[8px] text-[rgba(255,255,255,0.5)]">Hace unos segundos</div>
                            </div>
                        </div>
                    </div>
