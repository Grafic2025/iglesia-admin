        ...
        <div className="bg-[#1E1E1E] rounded-2xl border border-[#333] overflow-hidden mb-4">
            <div className="p-4 flex flex-col md:flex-row gap-4 items-start md:items-center">
                <input
                    ...
                    className="flex-1 bg-white/5 text-white px-5 py-3 rounded-2xl border border-white/10 outline-none focus:border-accent/50 transition-all font-bold placeholder:text-white/20"
                />
                <select
                    value={filtroHorario}
