...
const ModalSelectorPlantilla: React.FC<ModalSelectorPlantillaProps> = ({ onSelectTemplate, onClose }) => {
    const SERVICE_TEMPLATES = [
        {
            ...
            staffRoles: ['Director/Pastor', 'Worship Leader', 'Soprano', 'Tenor', 'Batería', 'Bajo', 'Ginterfaztarra Eléctrica 1', 'Piano', 'Sonidista', 'Slides TV']
        },
        {
        ...
        },
        {
            ...
            staffRoles: ['Director/Pastor', 'Worship Leader', 'Piano', 'Ginterfaztarra Acústica', 'Sonidista', 'Ujier']
        }
    ];
...
export default ModalSelectorPlantilla;
