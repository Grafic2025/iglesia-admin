...
interface GraficoCrecimientoProps {
    ...
    GROWTH_RANGES: any[]; // Recibe RANGOS_CRECIMIENTO con .clave
}

const GraficoCrecimiento: React.FC<GraficoCrecimientoProps> = ({ data, growthRange, setGrowthRange, GROWTH_RANGES }) => {
    return (
            ...
            <div className="h-[250px]">
                <ResponsiveContainer width="100%" height={250}>
                    <ReLineChart data={data}>
                        ...
                        />
                        <Line type="monotone" dataKey="cantidad" stroke="#00D9FF" strokeWidth={3} dot={{ fill: '#00D9FF', r: 6 }} activeDot={{ r: 8 }}>
                            <LabelList dataKey="cantidad" position="top" fill="#00D9FF" fontSize={10} fontWeight="bold" />
                        </Line>
