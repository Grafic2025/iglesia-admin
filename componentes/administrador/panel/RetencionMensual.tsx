        ...
        <div className="bg-[#1e1e1e] border border-white/5 rounded-2xl p-6 shadow-xl relative overflow-hidden h-full flex flex-col justify-between">
            ...
            <div className="flex items-center gap-3 mb-4">
                ...
                <div>
                    ...
                    <p className="text-[#888] text-[10px] uppercase font-bold">Últimos 30 días</p>
                </div>
            </div>
            ...
            <div className="flex flex-col items-center justify-center py-4">
                <div className="relative w-32 h-32 flex items-center justify-center">
                    ...
                    <div className="text-center mt-2">
                        <span className="text-4xl text-white font-black">{tasa || 0}<span className="text-lg text-[#888]">%</span></span>
                        <p className="text-[#A8D500] text-[10px] font-black uppercase mt-1 flex items-center gap-1 justify-center"><Activity size={10} /> +5% este mes</p>
                    </div>
                </div>
            </div>
